      ...
      buttons: [
        {
          ...
          handler: (data) => {
            ...
            firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).get().then(val => {
              ...
              firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({ score: this.score + 1 });
...
console.log("foul commited = ", this.currmatch[0].fixtureid)
                                                          ...
                                                          firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).get().then(res=>{
                                                            res.data();
                                                            let obj =res.data();
                                                            firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({yellow : obj.yellow+1});
...
firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({red: obj.red+1});
...
":"+this.secs.toString(),playerName:data })
                            ...
                            firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({offsides: obj.offsides+1});                   
                                                                                      })   
...
firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({corners: obj.corners+1});
})   
                                                                                                                            }
