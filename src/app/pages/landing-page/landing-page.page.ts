...
this.btn3 =true;
  ...
  firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({goal: firebase.firestore.FieldValue.arrayUnion({scoretime:this.mins.toString()+
    ...
    buttons: [
      {
        ...
        handler: (data) => {
          ...
          firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).get().then(res=>{
              ...
              firebase.firestore().collection('MatchFixtures').doc(this.currmatch[0].fixtureid).update({agoal: firebase.firestore.FieldValue.arrayUnion({scoretime:this.mins.toString()+
